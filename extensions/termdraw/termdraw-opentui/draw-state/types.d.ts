 ...
 */
export declare const BRUSHES: readonly ["#", "*", "+", "x", "o", ".", "•", "░", "▒", "▓"];
export declare const BOX_STYLES: readonly ["auto", "light", "heavy", "double", "dashed"];
export declare const LINE_STYLES: readonly ["smooth", "light", "double", "dashed"];
export declare const INK_COLORS: readonly ["white", "red", "orange", "yellow", "green", "cyan", "blue", "magenta"];
export declare const TEXT_BORDER_MODES: readonly ["none", "single", "double", "underline"];
export declare const DRAW_DOCUMENT_VERSION: 1;
...
export declare const DEFAULT_CANVAS_INSETS: CanvasInsets;
