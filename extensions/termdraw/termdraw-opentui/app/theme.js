...
export const ELBOW_STYLE_OPTIONS = [
    { style: "light", sample: "─│", label: "Single" },
    { style: "double", sample: "═║", label: "Double" },
    { style: "dashed", sample: "┄┆", label: "Dashed" },
];
...
export const TEXT_BORDER_OPTIONS = [
...
export const FULL_CHROME_CANVAS_INSETS = {
    left: 1,
    top: 3,
    right: 1,
    bottom: 2,
...
export const EDITOR_CANVAS_INSETS = {
    left: 0,
    top: 0,
    right: 0,
    bottom: 0,
...
export function getCanvasInsets(chromeMode) {
