...
```bash
export LINEAR_MCP_1PASSWORD_REF='op://Private/Linear API Key/token'
```
...
| `LINEAR_MCP_1PASSWORD_REF` | unset | 1Password secret reference, e.g. `op://Private/Linear API Key/token`. |
