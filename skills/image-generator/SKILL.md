...
description: Generate and edit images using Gemini image models. Use this skill when the user asks you to generate images, create visuals, edit photos, create logos, generate product mockups, or perform image generation or image editing tasks.
---
