...
Generate and edit images using Gemini image models. The skill defaults to `gemini-3-pro-image-preview` for high-quality asset production and can use another model through `GEMINI_IMAGE_MODEL`.
...
Before using this skill, set your Gemini API key as an environment variable:
