...
2. Run: node ~/.codex/skills/mesh-security/lib/analyzer-wrapper.js ./istio-config.yaml
...
```javascript
const { analyzeConfig, formatFindings } = require('~/.codex/skills/mesh-security/lib/analyzer-wrapper.js');
